...
\author{\firstname{James Andrew} \lastname{Gooding}\inst{1}\fnsep\thanks{\email{Jamie.Gooding@cern.ch}} \and
        \firstname{Pratik} \lastname{Jawahar}\inst{2} \and
        \firstname{Micol} \lastname{Olocco}\inst{1} \and
        \firstname{Author} \lastname{4}\inst{3} \and
        \firstname{Author} \lastname{5}\inst{4}
        } 
