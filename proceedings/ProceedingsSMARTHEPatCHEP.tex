...
\author{\firstname{James Andrew} \lastname{Gooding}\inst{1}\fnsep\thanks{\email{Jamie.Gooding@cern.ch}} \and
        \firstname{Caterina} \lastname{Doglioni}\inst{2}\fnsep\thanks{\email{Caterina.Doglioni@cern.ch}} \and
        \firstname{Pratik} \lastname{Jawahar}\inst{2}\fnsep\thanks{\email{Pratik.Jawahar@cern.ch}} 
}

%\thanks{We acknowledge funding from the European Union Horizon 2020 research and innovation programme, call H2020-MSCA- ITN-2020, under Grant Agreement n. 956086}
